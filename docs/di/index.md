Dependency Injection in `deepblu`
==========================

This module provides a simple dependency injection library, based on a registry of bindings between interfaces and their
